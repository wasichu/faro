defmodule Faro.FaroGame.RoundTest do
  ...
  describe "round replay" do
    test "stored deck can reconstruct the same shuffle via GameEngine" do
      ...
      shuffle_seed = Fairness.derive_shuffle_seed(loaded.server_seed, loaded.client_seed, loaded.nonce)
  ...
  describe "audit record" do
    test "persists audit data and verifies" do
      ...
      audit =
        Audit.from_round(finished_round, commitment, server_seed, client_seed, nonce, original_deck)
        |> Audit.verify_full()
